...
import com.dynasty.common.json.JSONObject;
import com.dynasty.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        String[] array = { "dynasty 1", "dynasty 2", "dynasty 3", "dynasty 4", "dynasty 5" };
        AjaxResult ajax = new AjaxResult();
